If Exists(Select [name] From SysObjects Where xtype='P' and [Name]='USP_REP_AP_FORM_VAT225')
Begin
	Drop Procedure USP_REP_AP_FORM_VAT225
End
GO
-- =============================================  
-- Author   : Hetal L Patel
-- Create date: 16/05/2007  
-- Description: This Stored procedure is useful to generate AP VAT Form 225
-- Modify date: 16/05/2007  
-- Modified By: Changes has been done by Gaurav Tanna on 07/10/2014 for BUG-23933
-- Remark:  
-- =============================================  
CREATE Procedure [dbo].[USP_REP_AP_FORM_VAT225]  
...
STM.FORM_NM,AC1.S_TAX,Item=space(50)
INTO #formvat_200
FROM PTACDET A 
...
select Distinct A.Net_Amt,A.taxamt,A.Gro_amt,A.inv_no,A.Date,A.ac_name,Address='',A.Form_nm,A.S_tax,b.it_name
from vattbl A
Inner Join IT_MAST B on a.It_code = B.It_code
where A.BHENT = 'PT' And A.Date Between @sdate and @edate And A.S_tax <> ''
Order by A.Inv_No
-- bug-23933 - end here 
...
FETCH NEXT FROM Cur_VatPay INTO @TAXONAMT,@TAXAMT,@ITEMAMT,@INV_NO,@DATE,@PARTY_NM,@ADDRESS,@FORM_NM,@S_TAX,@ITEM
 ...
 BEGIN
	...
	INSERT INTO #FORMVAT_200 (PART,PARTSR,SRNO,RATE,AMT1,AMT2,AMT3,INV_NO,DATE,PARTY_NM,ADDRESS,FORM_NM,S_TAX,ITEM) VALUES (1,'1',CHAR(@CHAR),@PER,@TAXONAMT,@TAXAMT,@ITEMAMT,@INV_NO,@DATE,@PARTY_NM,@ADDRESS,@FORM_NM,@S_TAX,@ITEM)
