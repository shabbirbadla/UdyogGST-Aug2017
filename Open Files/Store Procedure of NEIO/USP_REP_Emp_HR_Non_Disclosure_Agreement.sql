IF EXISTS(SELECT * FROM SYS.OBJECTS WHERE [NAME]='USP_REP_Emp_HR_Non_Disclosure_Agreement')
BEGIN
DROP PROCEDURE [USP_REP_Emp_HR_Non_Disclosure_Agreement]
END
GO
-- =============================================
-- Author:		
...
-- =============================================
Create procedure [dbo].[USP_REP_Emp_HR_Non_Disclosure_Agreement]
