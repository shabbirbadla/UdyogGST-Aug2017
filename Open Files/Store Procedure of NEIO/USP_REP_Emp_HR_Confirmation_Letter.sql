IF EXISTS(SELECT * FROM SYS.OBJECTS WHERE [NAME]='USP_REP_Emp_HR_Confirmation_Letter')
BEGIN
DROP PROCEDURE [USP_REP_Emp_HR_Confirmation_Letter]
END
GO
-- =============================================
-- Author:		
...
-- =============================================
Create procedure [dbo].[USP_REP_Emp_HR_Confirmation_Letter]
...
select employeecode,employeename,doj,dol,designation ,confirmdate from employeemast where 
