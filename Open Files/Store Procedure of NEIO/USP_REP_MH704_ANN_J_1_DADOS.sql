if exists(select [name] from sysobjects where [name]='USP_REP_MH704_ANN_J_1_DADOS' and xtype='P')
drop procedure USP_REP_MH704_ANN_J_1_DADOS
GO
...
create PROCEDURE [dbo].[USP_REP_MH704_ANN_J_1_DADOS]
...
Update #MHFRM704J_1 set  PART = isnull(Part,0) , Partsr = isnull(PARTSR,''), SRNO = isnull(SRNO,''),
 ...
 SELECT SRNO=ROW_NUMBER() OVER (ORDER BY AMT2 DESC),S_TAX,AMT1,AMT2,AMT3 FROM #MHFRM704J_1 order by AMT2 DESC
