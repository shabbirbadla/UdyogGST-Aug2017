...
If Type('_Screen.ActiveForm.pcvtype')<>'U'
	If Inlist(_Screen.ActiveForm.pcvtype,'E1','S1','IB','J6','BP','BR','CP','CR','C6','D6','RV','J8') And (_Screen.ActiveForm.addmode Or _Screen.ActiveForm.editmode)    && Added by Shrikant S. on 06/02/2017 for GST
