/****** Object:  StoredProcedure [dbo].[USP_REP_118REC]    Script Date: 02/05/2010 09:57:49 ******/
SET ANSI_NULLS ON
GO
...
---<<    USP_REP_118REC(IMPORTED) THIS STORED PROCEDURE USEFUL TO GENERATE ANNE-118(RECEIPT)  REPORT   >>

CREATE PROCEDURE  [dbo].[USP_REP_118REC] 
...
,@VMAINFILE='PTMAIN',@VITFILE='PTITEM',@VACFILE='PTACDET'--,@VRULE ='IMPORTED'
,@VDTFLD ='DATE'
,@VLYN =NULL
,@VEXPARA=@EXPARA
,@VFCON =@FCON OUTPUT
...
BEGIN
	SET @FCON = @FCON + 'AND PTMAIN.[RULE] = ''IMPORTED'''
END
...
DECLARE @SQLCOMMAND NVARCHAR(4000), @VCOND NVARCHAR(2000)
 ...
 SET @SQLCOMMAND='SELECT PTITEM.TRAN_CD,PTITEM.ENTRY_TY,PTITEM.INV_NO,PTITEM.DATE,IT_MAST.IT_NAME,PTITEM.QTY,PTITEM.ITEM_NO,PTITREF.RINV_NO,PTMAIN.U_BENO,PTMAIN.U_BEDATE,PTMAIN.U_PINVNO,PTMAIN.U_PINVDT,PTITEM.U_EXPMARK,PTITEM.U_CIFAMT,PTITEM.U_ACAMT,PTITEM.U_EXAMT,PTITEM.U_ACAMT1,PTITEM.U_HACAMT1,PTITEM.U_CESSAMT,PTITEM.U_HCESSAMT,PTITEM.U_IMPDUTY,IT_MAST.P_UNIT,PTMAIN.[RULE],ARITREF.RINV_NO,PTITEM.U_ASSEAMT FROM PTITEM '
...
IF @@ERROR = 0
BEGIN
PRINT 'USP_REP_118REC(IMP) SUCCESSFULLY CREATED..!'
END
