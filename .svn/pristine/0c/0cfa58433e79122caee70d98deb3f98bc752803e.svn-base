If Exists(Select [name] From SysObjects Where xtype='P' and [Name]='USP_REP_AP_VAT_200D')
Begin
	Drop Procedure USP_REP_AP_VAT_200D
End
GO
-- =============================================
-- Author:		Hetal L. Patel
-- Create date: 01/06/2009	
-- Description:	This Stored procedure is useful to generate AP VAT FORM 200D.
-- Modify date: 24/06/2009
-- Modified By: Dinesh 
-- Modified By: Changes has been done by Gaurav Tanna on 07/10/2014 for BUG-23933
-- Remark:
-- =============================================
CREATE Procedure [dbo].[USP_REP_AP_VAT_200D]
