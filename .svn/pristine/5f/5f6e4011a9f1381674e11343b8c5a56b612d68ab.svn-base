    ...
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                //args = new string[4];
                //args[0] = "U011415";
                ////args[0] = "S031314";// "M051313";//dbname
                //args[1] = @"F:\Client Projects\VAT Templates\VudyogSDK\Bmp\Icon_VudyogSDK.ico";//icon path
                ...
                if (args.Length > 0)
                {
                    ...
                    try
                    {
                        Application.Run(new frmForm231(connectionstring, dbname, iconpath, vumess, compid));
                    }
                    catch (Exception Ex)
                    {
