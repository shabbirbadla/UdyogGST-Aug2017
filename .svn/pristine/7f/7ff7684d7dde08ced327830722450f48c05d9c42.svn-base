    ...
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                //args[1] = @"F:\Client Projects\Metso\VudyogSDK\Bmp\Icon_VudyogSDK.ico";//icon path
                ...
                if (args.Length > 0)
                {
                    ...
                    try
                    {
                        Application.Run(new frmDamanDiu(connectionstring, dbname, iconpath, vumess, compid));
                    }
                    catch (Exception Ex)
                    {
