...
namespace Karnataka
{
    public partial class frmKarnataka : Form
    {
        #region Variables Declarations
        cls_Karnataka_DataTemplate m_obj_Karnataka_DataTemplate;
        ...
        private void GetData()
        {
            try
            {
                ...
                m_obj_Karnataka_DataTemplate.FromDate = FromDate;
                m_obj_Karnataka_DataTemplate.ToDate = ToDate;
                m_obj_Karnataka_DataTemplate.SelectedTemplate = SelectedTemplate;
                m_obj_Karnataka_DataTemplate.BgWorkProgress = backgroundWorker;
                m_obj_Karnataka_DataTemplate.GetProcData();

                //XML Creation
                //XmlTextWriter xmlstr = m_obj_Daman_DiuDataTemplate.GenerateXML(m_obj_Daman_DiuDataTemplate.DsMain, cFileName.Trim());
                XmlTextWriter xmlstr = m_obj_Karnataka_DataTemplate.GenerateXML(m_obj_Karnataka_DataTemplate.DsMain.Tables[1], cFileName.Trim());
        ...
        public frmKarnataka(string connectionstring, string dbname, string iconpath, string vumess, int compid)
        {
            InitializeComponent();
            ...
            m_obj_Karnataka_DataTemplate = new cls_Karnataka_DataTemplate(ConnString);
            m_obj_Karnataka_DataTemplate.CompId = compid;
            m_obj_Karnataka_DataTemplate.GetCompanyData();
            _Sta_dt = m_obj_Karnataka_DataTemplate.FromDate;
            _End_dt = m_obj_Karnataka_DataTemplate.ToDate;
        }
            ...
            try
            {
                ...
                switch (SelectedTemplate)
                {
                    ...
                    case "INTERSTATE SALES":
                        fileName = "Interstatesales";
                        break;
                    case "INTERSTATE PURCHASE":
                        fileName = "Interstatepurchase";
                        break;
                    case "VAT EXPORT INVOICE":
                        fileName = "VATExportinvoice";
                        break;
                }
        ...
        private void frmKarnataka_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void frmKarnataka_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
