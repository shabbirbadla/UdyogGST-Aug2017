Create Procedure [dbo].[Usp_Ent_GenStock]
@Edate SmallDateTime, 
...
set @sqlcmd=@sqlcmd+' '+'Select a.entry_ty,a.Date,case when a.[rule]=''NON-MODVATABLE'' THEN a.[rule] ELSE (Case when a.[rule]='''' then '''' else ''MODVATABLE'' end) END ,a.Tran_cd,b.Qty,b.pmkey,Ware_nm'
