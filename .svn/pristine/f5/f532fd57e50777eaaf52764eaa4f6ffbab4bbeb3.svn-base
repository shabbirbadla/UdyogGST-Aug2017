...
namespace UdyogMaterialRequirementPlanning
{
    class clsCommon
    {
        ...
        // added by suraj for bug-29249 
        private static string _Valid_Trans;
        public static string Valid_Trans
        {
            get { return _Valid_Trans; }
            set { _Valid_Trans = value; }
        }

        // added by suraj for bug-29249 
        private static int _Wharehouseapplicable;
        public static int Wharehouseapplicable
        {
            get { return _Wharehouseapplicable; }
            set { _Wharehouseapplicable = value; }
        }
        ...
        public static Boolean CheckApproval = false;
