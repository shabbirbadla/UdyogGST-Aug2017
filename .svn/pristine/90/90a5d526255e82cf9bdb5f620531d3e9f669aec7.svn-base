Lparameters lBugid ,dirpath &&,lVumess
Store '' To currPath , exename
*!*	DO d:\vudyogsdk\uecustmodaccui_1.prg
*!*	currDir = Curdir()
*!*	Messagebox("Current Directory : "+currDir)
*!*	Messagebox("Apath : "+dirpath)
*!*	Messagebox(lBugid,Program())
*!*	currPath = Substr(currDir,1,At("\",currDir,2)) + 'CustModAccUI\UpdtExe'
currpath = dirpath + 'CustModAccUI\UpdtExe'
*!*	Messagebox(currPath)
Try
	If Empty(lBugid)
		exename = '\vu10Updt_'
