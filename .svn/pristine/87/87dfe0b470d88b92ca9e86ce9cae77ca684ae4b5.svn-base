IF EXISTS (SELECT [NAME] FROM SYSOBJECTS WHERE [NAME]='USP_REP_CASH_PAYMENT' AND XTYPE='P')
DROP PROC USP_REP_CASH_PAYMENT
GO
set ANSI_NULLS ON
...
CREATE procedure [dbo].[USP_REP_CASH_PAYMENT]
