    ...
    public partial class frmMRPPlan1 : Form
    {
        ...
        //}
            ...
            if (BomNotDefined.Trim().Length > 0 && BommID.Trim().Length == 0) // no bom id items
            {
                ...
                DialogResult result = MessageBox.Show("BOM not attached to the Goods: " + BomNotDefined.Trim().Substring(1).Trim() + Environment.NewLine + "Need BOM to Generate Indent or Workorder", "", MessageBoxButtons.OK); //Added  by Suraj Kumawat for GST Date on 11-05-2017
            ...
            else if (BomNotDefined.Trim().Length > 0 && BommID.Trim().Length != 0) //bom id + no bom id items
            {
                ...
                DialogResult result = MessageBox.Show("BOM not attached to the Goods: " + BomNotDefined.Trim().Substring(1).Trim() + Environment.NewLine + "Do you want to continue with selected Goods?", "", MessageBoxButtons.YesNo); // Added by Suraj Kumawat for GST Date on 17-08-2017
                if (result == DialogResult.No)
                {
                    //Application.Exit();
                    return;
        ...
        private void GridSetting()
        {
            ...
            gridView1.Columns[4].Caption = "Goods"; // Added by Suraj Kumawat for GST date on 11-05-2017 --"Item";
