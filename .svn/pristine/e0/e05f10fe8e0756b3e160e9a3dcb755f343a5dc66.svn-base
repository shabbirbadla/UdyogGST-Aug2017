If Exists(Select [name] From SysObjects Where xtype='P' and [Name]='USP_REP_AP_VAT_200F')
Begin
	Drop Procedure USP_REP_AP_VAT_200F
End
GO
-- =============================================
-- Author:		Hetal L. Patel
-- Create date: 01/06/2009	
-- Description:	This Stored procedure is useful to generate AP VAT FORM 200F.
-- Modify date: 24/06/2009
-- Modified By: Dinesh 
-- Modified By: Changes has been done by Gaurav Tanna on 07/10/2014 for BUG-23933
-- Remark:
-- =============================================
CREATE Procedure [dbo].[USP_REP_AP_VAT_200F]
...
SET @AMTA1=CASE WHEN @AMTA1 IS NULL THEN 0 ELSE @AMTA1 END
INSERT INTO #APVAT 
(Part,SrNo1,Taxable_Amt,taxamt1,taxamt2,taxamt3,taxamt4,tax_name,level1,st_type) VALUES (1,'D',@AMTA1,0,0,0,0,'',0,'')

Set @AMTA1 = 0
Set @AMTA2 = 0
INSERT INTO #APVAT 
(Part,SrNo1,Taxable_Amt,taxamt1,taxamt2,taxamt3,taxamt4,tax_name,level1,st_type) VALUES (1,'E',0,0,0,0,0,'',0,'')
--<- PART1
  ...
  if (@nettax <> 0) Or (@Per = 1.00 Or @Per = 4.00 Or @Per = 12.50)  
	  Begin
			IF (@per = 4.00)		
				INSERT INTO #APVAT 
	           (Part,SrNo1,Taxable_Amt,taxamt1,taxamt2,taxamt3,taxamt4,tax_name,level1,st_type) 
			   VALUES (2,'B',@NETEFF,0,0,@NETTAX,0,'',@PER,'')
			ELSE IF (@per = 12.50)
				INSERT INTO #APVAT 
	           (Part,SrNo1,Taxable_Amt,taxamt1,taxamt2,taxamt3,taxamt4,tax_name,level1,st_type) 
			   VALUES (2,'C',@NETEFF,0,0,@NETTAX,0,'',@PER,'')
			ELSE IF (@per = 1.00)
			   INSERT INTO #APVAT 
	           (Part,SrNo1,Taxable_Amt,taxamt1,taxamt2,taxamt3,taxamt4,tax_name,level1,st_type) 
			   VALUES (2,'A',@NETEFF,0,0,@NETTAX,0,'',@PER,'')	
	end
-- bug-23933 - end here 
...
Set @PER = 0
INSERT INTO #APVAT 
(Part,SrNo1,Taxable_Amt,taxamt1,taxamt2,taxamt3,taxamt4,tax_name,level1,st_type) VALUES (2,'CA',@AMTA1,0,0,0,@AMTA2,'',@PER,'')
...
Set @PER = 0
INSERT INTO #APVAT 
(Part,SrNo1,Taxable_Amt,taxamt1,taxamt2,taxamt3,taxamt4,tax_name,level1,st_type) VALUES (2,'CB',0,@AMTA1,0,@AMTA2,0,'',@PER,'')
