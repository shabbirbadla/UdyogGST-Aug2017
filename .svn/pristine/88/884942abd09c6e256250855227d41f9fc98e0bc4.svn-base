    ...
    public partial class frmProcessWatcher : Form
    {
        ...
        private void StartProcess(DoWorkEventArgs e)
        {
            try
            {
                ...
                //m_Obj_ProcExecute.LogFilePath = Application.StartupPath + "\\Log\\";
                m_Obj_ProcExecute.LogFilePath = m_Obj_ProcExecute.CompanyPath + "\\Log\\";    // Changed by Sachin N. S. on 31/01/2014 for Bug-20211
