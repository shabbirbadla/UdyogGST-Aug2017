IF EXISTS(SELECT * FROM SYS.OBJECTS WHERE [NAME]='USP_REP_LOC_MAST')
BEGIN
DROP PROCEDURE USP_REP_LOC_MAST
END
GO
...
-- Description:	This is useful for Location Master Report
-- Modify date: 
-- Remark:
-- =============================================

CREATE PROCEDURE [dbo].[USP_REP_LOC_MAST]
