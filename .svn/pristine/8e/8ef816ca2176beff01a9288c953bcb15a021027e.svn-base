...
go
IF EXISTS(SELECT [NAME] FROM SYS.PROCEDURES WHERE [NAME]='USP_REP_STOCKRESERVATION_DET_TRACKER')
BEGIN
	DROP PROCEDURE USP_REP_STOCKRESERVATION_DET_TRACKER
END
GO
...
--****************************************************************************--
CREATE PROCEDURE [dbo].[USP_REP_STOCKRESERVATION_DET_TRACKER]
AS
