if exists(select [name] from sysobjects where [name]='USP_REP_MH704_ANN_J_2' and xtype='P')
drop procedure USP_REP_MH704_ANN_J_2
GO
...
/*
EXECUTE USP_REP_MH702_ANN_J_2 '','','','04/01/2011','03/31/2015','','','','',0,0,'','','','','','','','','2011-2012',''
*/

-- =============================================
-- Author:		Sandeep Shah
-- Create date: 21/01/2014
-- Description:	MVAT Form 704 - Annexure-J_2
-- Modified By: 
-- Remark:      
...
create PROCEDURE [dbo].[USP_REP_MH704_ANN_J_2]
...
Update #MHFRM704J_2 set  PART = isnull(Part,0) , Partsr = isnull(PARTSR,''), SRNO = isnull(SRNO,''),
 ...
 SELECT * FROM #MHFRM704J_2 order by AMT2 DESC
