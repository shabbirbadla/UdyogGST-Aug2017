...
namespace eFillingExtraction
{
    class ReturnVer2
    {
        ...
        //public static int NoofTabs = 3;
        //public static string SheetNames = "Company,Challan,Deductee";
        public DataSet MainSet = new DataSet();

        public ReturnVer2(ReturnType returnType, FormType formType,string quarter)
        {
            ...
            switch (_ReturnType)
            {
                case ReturnType.eTDS:
                    ...
                    if (this._FormType == FormType.Form24Q && _Quarter=="Q4")
                    {
                        ...
                        SalDetailTable.Columns.Add(new DataColumn("NetPaymentPrev", typeof(decimal)));
                        SalDetailTable.Columns.Add(new DataColumn("TotPayment", typeof(decimal)));
                        ...
                        SalDetailTable.Columns.Add(new DataColumn("TDSCurrentE", typeof(decimal)));
                        SalDetailTable.Columns.Add(new DataColumn("TDSPrevE", typeof(decimal)));
                        ...
                        SalDetailTable.Columns.Add(new DataColumn("AtHigherRate", typeof(string)));
        ...
        public string GetFinalData(DataTable Data,DataTable SalDetails)
        {
            ...
            try
            {
                for (int i = 0; i < SalDetails.Rows.Count; i++)
                {
                    ...
                    SalaryRow["NetPaymentPrev"] = Convert.ToDecimal(SalDetails.Rows[i]["NetPaymentPrev"]);
                    SalaryRow["TotPayment"] = Convert.ToDecimal(SalDetails.Rows[i]["TotPayment"]);
                    ...
                    SalaryRow["TDSCurrentE"] = Convert.ToDecimal(SalDetails.Rows[i]["TDSCurrentE"]);
                    SalaryRow["TDSPrevE"] = Convert.ToDecimal(SalDetails.Rows[i]["TDSPrevE"]);
                    ...
                    SalaryRow["AtHigherRate"] = Convert.ToString(SalDetails.Rows[i]["AtHigherRate"]).Trim();
