...
namespace SQLEditor.WinGui.UserControls
{
	...
	/// </summary>
	public class UcDbConnectionSybaseASEClient : System.Windows.Forms.UserControl
	{
		...
		public UcDbConnectionSybaseASEClient(DataSource ds)
		{
		...
		public UcDbConnectionSybaseASEClient()
		{
			// This call is required by the Windows.Forms Form Designer.
			InitializeComponent();
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(UcDbConnectionSybaseASEClient));
			...
			this.label2.Text = "The Sybase ASE Data provider is an ADO.NET driver that provides native access to " +
			...
			this.txtFriendlyName.Text = "Sybase ASE";
			// 
			// groupBox1
			// 
			...
			// 
			// UcDbConnectionSybaseASEClient
			// 
			this.Controls.Add(this.groupBox2);
			this.Controls.Add(this.label2);
			this.Controls.Add(this.pictureBox1);
			this.Name = "UcDbConnectionSybaseASEClient";
		...
		public DataSource GetDataSource()
		{
			...
			dataSource.ConnectionType=DBConnectionType.SybaseASE;
