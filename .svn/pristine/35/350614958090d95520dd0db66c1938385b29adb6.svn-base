...
-- Description:	  This Stored procedure is useful to Generate data for AA Invoice Register.
-- Modified By:
-- Modified Date:
-- =============================================

CREATE PROCEDURE  [dbo].[USP_REP_AA_INV_REG]
...
SET @SQLCOMMAND=@SQLCOMMAND+', STMAIN.U_FOBSB, STMAIN.U_FOBBRC, STMAIN.NARR, Curr_mast.currencycd'
