/****** Object:  StoredProcedure [dbo].[USP_REP_118ISSUEIMP]    Script Date: 02/05/2010 09:57:05 ******/
SET ANSI_NULLS ON
GO
...
create PROCEDURE [dbo].[USP_REP_118ISSUEIMP] 
...
SET @SQLCOMMAND=@SQLCOMMAND+'LEFT JOIN PTITEM ON (PTITEM.ENTRY_TY=IPITREF.RENTRY_TY AND PTITEM.INV_NO=IPITREF.RINV_NO AND PTITEM.ITSERIAL=IPITEM.ITEM_NO)'
