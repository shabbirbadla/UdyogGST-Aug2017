...
([group],[desc],[rep_nm],[rep_nm1] --1
 ...
 ,'','',0,'',0,0 --5
 ,0,0,0,0,1,0,0,0 --6
 ,'','','_FRMLIST','EXECUTE USP_REP_SALESTAX_FORM_TOBE_ISSUED ;AC_NAME' --7
 ,'','P') --8
end
GO
...
([group],[desc],[rep_nm],[rep_nm1] --1
 ...
 ,'','',0,'',0,0 --5
 ,0,0,0,0,1,0,0,0 --6
 ,'','','_FRMLISTR','EXECUTE USP_REP_SALESTAX_FORM_TOBE_RECEIVED ;AC_NAME' --7
 ,'','P') --8
end
GO
...
([group],[desc],[rep_nm],[rep_nm1] --1
 ...
 ,'','',0,'',0,0 --5
 ,0,0,0,0,1,0,0,0 --6
 ,'','','_FRMLISTL','EXECUTE USP_REP_SALESTAX_FORM_TOBE_ISSUED ;AC_NAME' --7
 ,'','P') --8
end
GO
