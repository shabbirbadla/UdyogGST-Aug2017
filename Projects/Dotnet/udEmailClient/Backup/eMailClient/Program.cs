...
namespace eMailClient
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //**** Added by Sachin N. S. for Debugging -- Start
            //args = new string[9];
            //args[8] = "udpid6096DTM20110307112715";
            //args[7] = "1";
            //args[6] = "Usquare.exe";
            //args[5] = "Usquare pack";
            //args[4] = "";// "M051313";//dbname
            //args[3] = "M011314";// "M051313";//dbname
            //args[2] = "NO";
            //args[1] = "NO";//compid
            //args[0] = "1";//compid
            //**** Added by Sachin N. S. for Debugging -- End

            try
            {
                AppDetails.AppPath = Path.GetDirectoryName(Application.ExecutablePath).Trim();
                //AppDetails.AppPath = "D:\\VUDYOGSDK";
                int mCompanyId = 0;
                string mCompanynm = "";
                ...
                if (args.Length > 0)
                {
                    ...
                    if (Convert.ToString(args[1]).ToUpper().Trim() == "NO") //ADDED BY SATISH PAL
                    {
                        ...
                        Application.Run(new frmEmailSettings(mCompanyId, mconnectionstring, args[5].ToString(), args[6].ToString(), args[7].ToString(), args[8].ToString()));
                    }
                }
                else
                {
        ...
        private static string EvaluateConnectionString(string dbname)
        {
            ...
            //var directory ="D:\\VUDYOGSDK";     // Added by Sachin N. S. on 21/01/2014 for Bug-20211 -- To be removed
            ...
            if (File.Exists(directory + "\\Visudyog.ini"))
            {
                ...
                //MessageBox.Show("Testing - "+connectionstring);
    ...
    public class CallMessageBox
    {
        static public void Show(string ExcepMessage, string Mess)
        {
            ...
            MessageBox.Show(Mess + ExcepMessage
                    ...
                    + "\n\n"
                    + "For Scheduler : " + "\n"
                    + "eMailClientWizard.exe " + dbquote + "<COMPANY ID>" + dbquote + " " + dbquote + "<AUTO>" + dbquote + " " + dbquote + "<EmailID>" + dbquote
                    + "\n"
                    + "AUTO Parameter indicate for ALL IDs" + "\n"
                    + "\nScheduler for All IDs\n"
                    + "eMailClientWizard.exe " + dbquote + "COMPANY ID" + dbquote + " " + dbquote + "AUTO" + dbquote
                    + "\n\n"
                    + "Scheduler for Selected ID \n"
                    + "eMailClientWizard.exe " + dbquote + "COMPANY ID" + dbquote + " " + dbquote + "AUTO" + dbquote + " " + dbquote + "1,2" + dbquote
                    + "\n\n"
                    + "For Email client Interface : " + "\n"
                    + "eMailClientWizard.exe " + dbquote + "COMPANY ID" + dbquote,
