...
namespace eMailClient
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //args[7] = "4";
            //args[6] = "VudyogPRO.exe";
            //args[5] = "usquare pack";
            //args[4] = @"SPATIL\SQLEXPRESS2008";
            //args[3] = "M021516";    // "m051313";//dbname
            //args[2] = "no1";
            //args[1] = "no";         //compid
            //args[0] = "4";          //compid
            ...
            try
            {
                ...
                //AppDetails.AppPath = "D:\\USQUARE"; // }Pankaj
                int mCompanyId = 0;
                string mCompanynm = "";
                ...
                if (args.Length > 0)
                {
                    ...
                    //icoPath = @"D:\Usquare\Bmp\Icon_10USquare.ico"; // Pankaj
        ...
        private static string EvaluateConnectionString(string dbname)
        {
            ...
            //var directory = "D:\\Usquare";//Pankaj
