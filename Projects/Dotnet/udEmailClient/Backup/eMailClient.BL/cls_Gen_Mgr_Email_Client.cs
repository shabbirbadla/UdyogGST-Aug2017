...
namespace eMailClient.BLL
{
    public class cls_Gen_Mgr_Email_Client : cls_Gen_Ent_Email_Client, ICommonBLL
    {
        ...
        public enum eMailClient_RowName : int
        {
            ...
            digitalSign // Added By pankaj For digital Signature
        }
        #endregion
        ...
        public void Insert()
        {
            ...
            try
            {
                ...
                SqlParameter[] m_spParam = { new SqlParameter("@action","Insert"),
                                       ...
                                       //**** Added by Sachin N. S. on 15/01/2014 for Bug-20211 ****// -- End
                                       new SqlParameter("@digsign",digitalSign) // Added By pankaj For digital Signature
                                       };
        ...
        private void Binding(DataRow m_rowDsSelect)
        {
            ...
            // Added By pankaj For digital Signature Start
            if (DBNull.Value == m_rowDsSelect["digsign"])
                digitalSign = false;
            else
                digitalSign = Convert.ToBoolean(m_rowDsSelect["digsign"]);
            // Added By pankaj For digital Signature End
        }
