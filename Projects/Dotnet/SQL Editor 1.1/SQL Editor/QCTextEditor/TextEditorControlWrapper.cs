			...
			public InfoMessage(Point startPoint, MessageType messageType, double percentPositionFormTop, string Message)
			{
				...
				switch(messageType)
				{
					case MessageType.Info:
						this.Picture.Image=System.Drawing.Image.FromStream(CopyEmbeddedResource("SQLEditor.Embedded.infomessage.gif"));
						break;
					case MessageType.Warning:
						this.Picture.Image=System.Drawing.Image.FromStream(CopyEmbeddedResource("SQLEditor.Embedded.infowarning.gif"));
						break;
